...
class Games(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        super(Games, self).__init__(*args, **kwargs)
...
#---------------------------------
    def goto(self, image_path):
        ...
        print(naam)
        if naam =='Manillen':
            subprocess.call(["python3",vastsysteem_path + "/Games/Manillen.py"])
        elif naam == 'Patiance':
            subprocess.call(["python3",vastsysteem_path + "/Games/Patience.py"])
        elif naam == 'Blinken':
            subprocess.call(["python3",vastsysteem_path + "/Games/Blinken.py"])
        elif naam == 'TuxPusher':
            subprocess.call(["python3",vastsysteem_path + "/Games/TuxPusher.py"]) 
        else:
    ...
    def load_images(self):
           folder_path = vastsysteem_path + "/Games/icons"  # Update the folder path here
