...
def download_audio(url, folder):
    try:
        ...
        # Rename the audio file to the title of the video
        video_title = youtube.title
        new_file_name = os.path.join(folder, video_title + ".mp3")
        os.rename(mp3_file, new_file_name)
        ...
        thumbnail_file = os.path.join(folder, "CDHOES", video_title + ".jpg")
...
def download_video(url, folder):
    try:
        ...
        # Set the download folder
        video_file = video_stream.download(output_path=folder)

        # Rename the video file to the title of the video
        video_title = youtube.title
        new_file_name = os.path.join(folder, video_title + ".mp4")
