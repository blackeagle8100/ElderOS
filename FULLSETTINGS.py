...
crypterpath = vastsysteem_path + "/dencrypt.py"
         ...
         #pkill memeos
          ...
          for process in psutil.process_iter(attrs=['pid', 'name', 'cmdline']):
              try:
                ...
                pass
          subprocess.Popen(['python3', vastsysteem_path + '/MemeOS-autoresize.py'])  #open MEMEOS
...
if __name__ == "__main__":
    ...
    directory = '/home/slayer/VASTSYSTEEM'
    ...
    if not os.path.isfile(filepath):
        ...
        config.set('Settings', 'vinstellingen', '1')
        config.set('Settings', 'vinternet', '1')
        config.set('Settings', 'vweer', '1')
    ...
    vinstellingen = int(config.get('Settings', 'vinstellingen'))
