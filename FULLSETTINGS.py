 ...
 #------------defines--------------------
    ...
    def savestats(self):
         ...
         #pkill elderos
          ...
          command_line_to_kill1 = "python3 ElderOS.py"
          for process in psutil.process_iter(attrs=['pid', 'name', 'cmdline']):
              try:
                  if (process.info['cmdline'] and ' '.join(process.info['cmdline']) == command_line_to_kill) or (process.info['cmdline'] and ' '.join(process.info['cmdline']) == command_line_to_kill1) :
...
class AdvancedWindow(QMainWindow):
    def __init__(self):
        ...
        midlayer = QHBoxLayout()
        applayer = QVBoxLayout()
        applayer2 = QVBoxLayout()
        fbsettings = QVBoxLayout()
        watchsettings = QHBoxLayout()
        ...
        self.lblwatch = QLabel("Smartwatch ip:")
        self.txtwatch = QLineEdit()
        self.txtwatch.setText(watchip)
        self.lblwatch.setFont(QFont(fonttype, fontsize))
        self.txtwatch.setFont(QFont(fonttype, fontsize))
        ...
        self.chkweer = QCheckBox('Weer')
        self.chkint = QCheckBox('Internet')
        self.chkcal = QCheckBox('Kalender')
        self.chkwekker = QCheckBox('Wekker')
        ...
        self.chkweer.setStyleSheet(checkbox_style)
        self.chkint.setStyleSheet(checkbox_style)
        self.chkcal.setStyleSheet(checkbox_style)
        self.chkwekker.setStyleSheet(checkbox_style)

        self.chkweer.setChecked(vweer)
        self.chkint.setChecked(vinternet)
        self.chkcal.setChecked(vkalender)
        self.chkwekker.setChecked(vwekker)

        self.chkweer.setFont(QFont(fonttype, fontsize))
        self.chkint.setFont(QFont(fonttype, fontsize))
        self.chkcal.setFont(QFont(fonttype, fontsize))
        self.chkwekker.setFont(QFont(fonttype, fontsize))
        ...
        applayer2.addWidget(self.chkweer)
        applayer2.addWidget(self.chkint)
        applayer2.addWidget(self.chkcal)
        applayer2.addWidget(self.chkwekker)
        
        midlayer.addLayout(applayer)
        midlayer.addLayout(applayer2)
        ...
        watchsettings.addWidget(self.lblwatch, alignment=Qt.AlignmentFlag.AlignRight)
        watchsettings.addWidget(self.txtwatch, alignment=Qt.AlignmentFlag.AlignLeft)
        ...
        MainLayer.addLayout(watchsettings)
 ...
 #------------defines--------------------
    ...
    def savestats(self):
          ...
          if self.chkgames.isChecked():
                      ...
                      vchkgames = 0
          if self.chkweer.isChecked():
                     vchkweer = 1 
          else:
                     vchkweer = 0
          if self.chkint.isChecked():
                     vchkint = 1 
          else:
                     vchkint = 0
          if self.chkcal.isChecked():
                     vchkcal = 1 
          else:
                     vchkcal = 0
          if self.chkwekker.isChecked():
                     vchkwekker = 1 
          else:
                     vchkwekker = 0
         #Validating values
          ...
          config.set('Settings', 'vweer', str(vchkweer))
          config.set('Settings', 'vinternet', str(vchkint))
          config.set('Settings', 'vkalender', str(vchkcal))
          config.set('Settings', 'vwekker', str(vchkwekker))  

          config.set('Settings', 'smartip', str(smartip))
...
if __name__ == "__main__":
    ...
    if not os.path.isfile(filepath):
        ...
        config.set('Settings', 'smartip', '0.0.0.0')
    ...
    watchip = config.get('Settings', 'smartip')
    ...
    vweer = int(config.get('Settings', 'vweer'))
    vinternet = int(config.get('Settings', 'vinternet'))
    vkalender = int(config.get('Settings', 'vkalender'))
    vwekker = int(config.get('Settings', 'vwekker'))
