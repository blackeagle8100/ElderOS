...
# Set the stylesheet for the QScrollArea and its contents (playlist)
        ...
        QScrollBar::add-line:vertical {
            ...
            image: url(~/VASTSYSTEEM/icons/arrowup200.png); /* Replace with the path to your arrow image */
            }
        QScrollBar::sub-line:vertical {
            subcontrol-position: top;
            image: url(~/VASTSYSTEEM/icons/arrowdown200.png); /* Replace with the path to your arrow image */
            }
