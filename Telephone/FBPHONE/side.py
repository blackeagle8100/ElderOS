...
class BrowserApp(QMainWindow):
    ...
    def load_webpage(self):
        ...
        if len(sys.argv) > 1:
            url = sys.argv[1]
            #url = f"https://www.facebook.com/groupcall/ROOM:/?call_id=&has_video=true&initialize_video=true&users_to_ring[0]=110769975648602&use_joining_context=true&peer_id=110769975648602"
