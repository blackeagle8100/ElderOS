...
class ContactViewer(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.contacts = []
        with open(vastsysteem_path + '/Telephone/Contact/contacten.ini', 'r') as file:
    ...
    def on_select(self, item):
        ...
        image_path = f"{vastsysteem_path}/Telephone/Contact/{selected_contact['id']}.png"
    ...
    def startcall(self, image_id):
        ...
        print(call_url)
        subprocess.call(["python3", vastsysteem_path + "/Telephone/side.py", call_url])
