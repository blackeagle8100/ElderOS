...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  9 20:46:54 2023
...
""")
    ...
    def clickaccepteer(self):
            ...
            function accepteerclick() {
                var buttons = document.querySelectorAll('button.message-component.message-button.no-children.focusable.button.sp_choice_type_11.last-focusable-el');
                buttons.click();
                break;
