...
#------------defines--------------------
    ...
    def savestats(self):
        ...
        #open MEMEOS
         subprocess.Popen(['python3', 'MemeOS-autoresize.py'])
         
         # Use xdotool to search for the window by title and bring it to the front
         #NOT NEEEDED IT ALREADY STARTS FROM THE BEGINNING ON TOP
         self.close()
         #close settings
